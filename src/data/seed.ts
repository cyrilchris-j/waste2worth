...
export const safetyGuides: SafetyGuide[] = [
  { title: 'Battery handling', category: 'Battery', icon: 'battery', instructions: ['Do not puncture, crush, or open batteries.', 'Tape exposed terminals before transport.', 'Keep batteries dry and separated.'], warnings: ['Stop handling swollen, hot, or leaking batteries.'] },
  { title: 'Laptop dismantling', category: 'Laptop', icon: 'laptop', instructions: ['Power down and disconnect chargers.', 'Remove batteries only with suitable tools.', 'Sort boards, cables, and casing separately.'], warnings: ['Wear eye protection and gloves.'] },
  { title: 'PCB sorting', category: 'PCB', icon: 'cpu', instructions: ['Keep boards dry and in rigid containers.', 'Avoid sanding or burning components.', 'Label unknown boards for assessment.'], warnings: ['Never burn e-waste to recover metals.'] },
  { title: 'Cable handling', category: 'Cable', icon: 'cable', instructions: ['Bundle cables without tight knots.', 'Keep copper and mixed cable streams separate.', 'Use gloves when stripping is approved.'], warnings: ['Do not burn insulation.'] },
  { title: 'Display handling', category: 'Display', icon: 'monitor', instructions: ['Carry screens upright with two hands.', 'Use padding and avoid pressure on glass.', 'Keep broken panels sealed.'], warnings: ['Treat broken glass as a cut hazard.'] },
  { title: 'Damaged device', category: 'Damaged Device', icon: 'alert', instructions: ['Isolate heat, smoke, or swelling immediately.', 'Photograph damage from a safe distance.', 'Tell the receiving facility about hazards.'], warnings: ['Call local emergency services for fire or fumes.'] },
  { title: 'General handling', category: 'General Handling', icon: 'recycle', instructions: ['Wear gloves and closed shoes.', 'Wash hands after handling materials.', 'Use approved collection and recycling channels.'], warnings: ['Never mix e-waste with household waste.'] },
]
