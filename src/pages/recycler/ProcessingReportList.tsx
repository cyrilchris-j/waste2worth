          ...
          >
            ...
            <div className="grid grid-cols-3 gap-2 text-center">
              <div className="bg-gray-50 rounded-xl p-2">
                <p className="text-base font-bold text-gray-900">{report.receivedWeightKg}</p>
                <p className="text-xs text-gray-500">Received kg</p>
              </div>
              <div className="bg-gray-50 rounded-xl p-2">
                <p className="text-base font-bold text-gray-900">{report.processedWeightKg}</p>
            ...
            <div className="flex items-center justify-between">
              <span className="chip">{report.processingMethod}</span>
